                            ...
                            <div className="d-table">
                                <div className="d-table-cell">
                                    <div className="content">
                                        ...
                                        <a href="https://www.silveroakuni.ac.in/about" target='_blank' rel="noopener noreferrer" className="btn btn-primary">Read More</a>
                            ...
                            <div className="d-table">
                                <div className="d-table-cell">
                                    <div className="content">
                                        ...
                                        <a href="https://ieee.socet.edu.in/about-socet-sb/" target='_blank' rel="noopener noreferrer" className="btn btn-primary">Read More</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div className="d-table">
                                <div className="d-table-cell">
                                    <div className="content">
                                        ...
                                        <a href="https://ieeespsgs.org/" target='_blank' rel="noopener noreferrer" className="btn btn-primary">Read More</a>
                            ...
                            <div className="d-table">
                                <div className="d-table-cell">
                                    <div className="content">
                                        ...
                                        <a href="https://signalprocessingsociety.org/our-story/scope-mission" target='_blank' rel="noopener noreferrer" className="btn btn-primary">Read More</a>
