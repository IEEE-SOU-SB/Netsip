...
class Chief_Patron extends React.Component {
        ...
        return (
            <section className="speakers-area ptb-120 pb-0">
                ...
                <div className="row m-0">
                    ...
                    <div className="col-lg-3 col-sm-6 p-0">
                        <div className="single-speakers">
                            ...
                            <div className="speakers-content">
                                ...
                                <span>Vice President of Silver Oak University </span>
                            </div>
                            <ul>
                                {/* <li>
                                    <Link to="https://www.facebook.com/" target="_blank" className="facebook"><i className="icofont-facebook"></i></Link>
                    ...
                    {/*            /!* <span><b>Patron</b></span> *!/*/}
                    {/*            <span>Research Scientist (mmwave lab, NYCU, Taiwan), MOST fellow, Post Doc (TDTU, Vietnam), IEEE Senior Member, Secretary at IEEE Signal Processing Society, Gujarat Section</span>*/}
                    {/*        </div>*/}
                    {/*        <ul>*/}
                    {/*            /!* <li>*/}
                    {/*                <Link to="https://www.facebook.com/" target="_blank" className="facebook"><i className="icofont-facebook"></i></Link>*/}
                    ...
                    {/*            /!* <span><b>Patron</b></span> *!/*/}
                    {/*            <span>Head and Associate Professor @ECED, CKPCET, Vice Chair IEEE SPS Gujarat Chapter</span>*/}
                    {/*        </div>*/}
                    {/*        <ul>*/}
                    {/*            /!* <li>*/}
                    {/*                <Link to="https://www.facebook.com/" target="_blank" className="facebook"><i className="icofont-facebook"></i></Link>*/}
                    ...
                    {/*            <span>Dean, Diploma Engineering, Silver Oak University; Head, Department of Computer Engineering SOCET; Senior Member IEEE; Founding Member, Silver Oak University IEEE Student Branch; Chairperson, SIGHT IEEE Gujarat Section; Secretary, Computer Society, IEEE Gujarat Sections</span>*/}
                    {/*        </div>*/}
                    {/*        <ul>*/}
                    {/*            /!* <li>*/}
                    {/*                <Link to="https://www.facebook.com/" target="_blank" className="facebook"><i className="icofont-facebook"></i></Link>*/}
                    ...
                    {/*            <span>Asst. Professor-CE Dept. Silver Oak University; Faculty Branch Counsellor,IEEE SOU SB</span>*/}
                    {/*        </div>*/}
                    {/*        <ul>*/}
                    {/*            /!* <li>*/}
                    {/*                <Link to="https://www.facebook.com/" target="_blank" className="facebook"><i className="icofont-facebook"></i></Link>*/}
                    ...
                    {/*            <span>Asst. Professor at SILVER OAK UNIVERSITY; Faculty Advisor IEEE SOU WIE AG; Faculty advisor IEEE SOU SPS SBG; IEEE SOU CS SBG</span>*/}
                    {/*        </div>*/}
                    {/*        <ul>*/}
                    {/*            /!* <li>*/}
                    {/*                <Link to="https://www.facebook.com/" target="_blank" className="facebook"><i className="icofont-facebook"></i></Link>*/}
